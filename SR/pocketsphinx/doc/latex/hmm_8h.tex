...
H\+M\+M data structure and operation.
...
This number must be \char`\"{}bad\char`\"{} enough so that 4 times W\+O\+R\+S\+T\+\_\+\+S\+C\+O\+R\+E will not overflow. The reason for this is that the search doesn\textquotesingle{}t check the scores in a model before evaluating the model and it may require as many was 4 plies before the new \textquotesingle{}good\textquotesingle{} score can wipe out the initial W\+O\+R\+S\+T\+\_\+\+S\+C\+O\+R\+E initialization. 
