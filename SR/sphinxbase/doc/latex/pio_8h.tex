...
Custom fopen with error checking is implemented. fopen\+\_\+comp can open a file with .z, .Z, .gz or .G\+Z extension

W\+A\+R\+N\+I\+N\+G\+: Usage of stat\+\_\+retry will results in 100s of waiting time if the file doesn\textquotesingle{}t exist. 
