...
This file contains some basic matrix and linear algebra operations. In general these operate on positive definite matrices O\+N\+L\+Y, because all matrices we\textquotesingle{}re likely to encounter are either covariance matrices or are derived from them, and therefore a non-\/positive-\/definite matrix indicates some kind of pathological condition. 
